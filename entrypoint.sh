...
UUID=${UUID:-'e593b82c-9edd-49a3-9bea-67fc757f9b39'}
VMESS_WSPATH=${VMESS_WSPATH:-'/vmess-b4ddd962-7936-41d9-b8e2-cf1f581f2a78'}
VLESS_WSPATH=${VLESS_WSPATH:-'/vless-e39f2522-0c45-4753-b331-d1524b56f19a'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/trojan-5a103607-dace-4406-b561-6ea21dece539'}
SS_WSPATH=${SS_WSPATH:-'/shadowsocks-d1a807a1-53f7-4e61-a02e-b8b879446b84'}
